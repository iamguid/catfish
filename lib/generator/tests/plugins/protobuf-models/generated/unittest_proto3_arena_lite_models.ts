      ...
      switch (tag) {
        ...
        case 146:
          m.optionalNestedMessage =
            unittest_proto3_arena_lite_models.proto3_arena_lite_unittest.TestAllTypes.NestedMessage;
          continue;

        // ForeignMessage optional_foreign_message = 19
        case 154:
          m.optionalForeignMessage =
            unittest_proto3_arena_lite_models.proto3_arena_lite_unittest.ForeignMessage;
          continue;
        ...
        case 170:
          m.optionalNestedEnum =
            unittest_proto3_arena_lite_models.proto3_arena_lite_unittest.TestAllTypes.NestedEnum;
          continue;

        // ForeignEnum optional_foreign_enum = 22
        case 178:
          m.optionalForeignEnum =
            unittest_proto3_arena_lite_models.proto3_arena_lite_unittest.ForeignEnum;
          continue;
        ...
        case 386:
          const repeatedNestedMessageValue =
            unittest_proto3_arena_lite_models.proto3_arena_lite_unittest
  ...
  public static decode(b: Uint8Array): NestedTestAllTypes {
    ...
    while (r.pos < r.len) {
      ...
      switch (tag) {
        ...
        case 10:
          m.child =
            unittest_proto3_arena_lite_models.proto3_arena_lite_unittest.NestedTestAllTypes;
          continue;

        // TestAllTypes payload = 2
        case 18:
          m.payload =
            unittest_proto3_arena_lite_models.proto3_arena_lite_unittest.TestAllTypes;
          continue;
      }
    }
