...
export interface ITestMessageWithDummyObj {
  dummy: boolean;
}
...
export class TestMessageWithDummy implements ITestMessageWithDummy {
  ...
  public static decode(b: Uint8Array): TestMessageWithDummy {
...
export class TestOneof2 implements ITestOneof2 {
  ...
  public static decode(b: Uint8Array): TestOneof2 {
