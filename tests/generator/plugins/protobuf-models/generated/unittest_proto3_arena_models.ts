  ...
  implements INestedTestAllTypes
{
  ...
  contructor(opt_data: any) {
    jspb.Message.initialize(
      ...
      0,
      -1,
      NestedTestAllTypes.repeatedFields,
      null
    );
  }
  ...
  public get repeated_child(): NestedTestAllTypes {
    return jspb.Message.getRepeatedWrapperField(this, NestedTestAllTypes, 3);
  }

  public set repeated_child(value: NestedTestAllTypes): void {
    return jspb.Message.setRepeatedWrapperField(
      this,
      3,
...
export class TestPickleNestedMessage
  extends jspb.Message
  implements ITestPickleNestedMessage
{
  contructor(opt_data: any) {
    jspb.Message.initialize(this, opt_data, 0, -1, null, null);
  }
...
export namespace TestPickleNestedMessage {
  ...
  export namespace NestedMessage {
    ...
    export class NestedNestedMessage
      extends jspb.Message
      implements INestedNestedMessage
    {
      contructor(opt_data: any) {
        jspb.Message.initialize(this, opt_data, 0, -1, null, null);
      }
