...
export class TestAllTypes implements ITestAllTypes {
  ...
  optional_unverified_lazy_message: TestAllTypes.NestedMessage = null;
  optional_lazy_import_message: protobuf_unittest_import.ImportMessage = null;
  repeated_int32: number = [];
  repeated_int64: BigInt = [];
  repeated_uint32: number = [];
  repeated_uint64: BigInt = [];
  ...
  constructor(obj?: Partial<ITestAllTypes>) {
    ...
    if (obj?.optional_unverified_lazy_message ?? false) {
      this.optional_unverified_lazy_message =
        obj.optional_unverified_lazy_message;
    }
    if (obj?.optional_lazy_import_message ?? false) {
      this.optional_lazy_import_message = obj.optional_lazy_import_message;
    }
...
export class TestOneof2 implements ITestOneof2 {
  foo_enum?: TestOneof2.NestedEnum = null;

  constructor(obj?: Partial<ITestOneof2>) {
    if (obj?.foo_enum ?? false) {
      this.foo_enum = obj.foo_enum;
    }
  }
