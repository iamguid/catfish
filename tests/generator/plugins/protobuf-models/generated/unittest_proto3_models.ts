...
export interface ITestAllTypes {
  ...
  optional_lazy_import_message: protobuf_unittest_import.ImportMessage;
...
export class TestAllTypes extends jspb.Message implements ITestAllTypes {
  ...
  public get optional_unverified_lazy_message(): TestAllTypes.NestedMessage {
    return jspb.Message.getWrapperField(this, TestAllTypes.NestedMessage, 28);
  }

  public set optional_unverified_lazy_message(
  ...
  public get optional_lazy_import_message(): protobuf_unittest_import.ImportMessage {
    return jspb.Message.getWrapperField(
      this,
      protobuf_unittest_import.ImportMessage,
      115
  ...
  public set optional_lazy_import_message(
    value: protobuf_unittest_import.ImportMessage
  ): void {
    return jspb.Message.setWrapperField(
      this,
...
export interface ITestMessageWithDummy {
  dummy: boolean;
}

export class TestMessageWithDummy
  extends jspb.Message
  implements ITestMessageWithDummy
{
  contructor(opt_data: any) {
  ...
  public get dummy(): boolean {
    return jspb.Message.getBooleanFieldWithDefault(this, 536870911, false);
  }
...
export class TestOneof2 extends jspb.Message implements ITestOneof2 {
  private static oneofFieldsGroups: number[] = [[6]];
  ...
  contructor(opt_data: any) {
    jspb.Message.initialize(
      ...
      -1,
      null,
      TestOneof2.oneofFieldsGroups
    );
  }

  public get foo_enum(): TestOneof2.NestedEnum {
    return jspb.Message.getWrapperField(this, TestOneof2.NestedEnum, 6);
  }

  public set foo_enum(value: TestOneof2.NestedEnum): void {
    return jspb.Message.setOneofWrapperField(
      this,
      6,
      TestOneof2.oneofFieldsGroups[0],
      value
    );
  }
}
